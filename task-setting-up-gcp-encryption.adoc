...
+
Die Berechtigungen werden im bereitgestellt https://docs.netapp.com/us-en/cloud-manager-setup-admin/reference-permissions-gcp.html["Standardmäßig sind die Berechtigungen für das Connector-Dienstkonto festgelegt"^], Kann aber nicht angewendet werden, wenn Sie ein alternatives Projekt für den Cloud Key Management Service verwenden.
...
Siehe https://docs.netapp.com/us-en/cloud-manager-automation/index.html["BlueXP Automation Dokumentation"^] Weitere Informationen zur Verwendung des Parameters „GcpEncryption“.
