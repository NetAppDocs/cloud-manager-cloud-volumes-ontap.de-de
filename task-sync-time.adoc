...
Geben Sie über den einen NTP-Server an https://docs.netapp.com/us-en/cloud-manager-automation/cm/api_ref_resources.html["BlueXP API"^] Oder über die Benutzeroberfläche, wenn Sie möchten link:task-create-volumes.html#create-a-volume["Erstellen Sie einen CIFS-Server"].
