...
** Sie haben über die Benutzeroberfläche ein neues Cloud Volumes ONTAP System erstellt. In diesem Fall ist die Elastic Volumes Funktion auf dem anfänglichen Aggregat deaktiviert. Prüfen  Unten für weitere Informationen
...
+
Wenn Sie ein Volume erstellen, das gp3- oder io1-Festplatten verwendet, erstellt BlueXP das Volume automatisch auf einem Aggregat, in dem elastische Volumes aktiviert sind. Weitere Informationen finden Sie unter  happens when you create a volume.
...
+
Wenn Sie die Seite „Advanced Allocation“ aufrufen, können Sie ermitteln, ob die Funktion Elastic Volumes auf einem Aggregat aktiviert ist. Im folgenden Beispiel sind Elastic Volumes aktiviert, während aggr1 nicht unterstützt wird.

+
image:screenshot-elastic-volumes-enabled.png["Ein Screenshot mit zwei Aggregaten, in denen ein Feld mit aktiviertem Text „Elastic Volumes“ angezeigt wird."]
