...
Wenn BlueXP die Lizenz nicht hinzufügen kann, müssen Sie sie manuell zum Digital Wallet selbst hinzufügen. Wenn der Connector z. B. an einem Standort installiert ist, der keinen Internetzugang hat, müssen Sie die Lizenzen selbst hinzufügen.  purchased licenses to your account,Erfahren Sie, wie Sie Ihrem Konto erworbene Lizenzen hinzufügen.
